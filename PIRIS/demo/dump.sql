...
INSERT INTO `piris`.`client` (`name`, `surname`, `patronymic`, `sex`, `date_of_birth`, `is_pensioner`, `monthly_income`, `place_of_birth`, `mob_tel`, `cs_id`, `ms_id`, `address_id`, `passport_id`, `disability_id`) VALUES ('name', 'surname', 'patr', 'M', '1998.05.03', '0', '123', 'HZ_PLACE', '375-29-149-73-58', '1', '1', '1', '1', '1');